...
internal static class ResultTypeSourceBuilder
{
    ...
    {
        sb.AppendLine($"{indent}    public sealed class Result : global::MiniBus.IDispatchResult");
    ...
    {
        return typeName.Equals("global::MiniBus.NotFoundResult", StringComparison.Ordinal);
    }
