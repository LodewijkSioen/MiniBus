...
public class SyncValidatingHandler
{
    ...
    public global::Caravelle.ValidationResult Validate(Request request)
    {
...
public class AsyncValidatingHandler
{
    ...
    public Task<global::Caravelle.ValidationResult> Validate(Request request)
    {
        var errors = new global::Caravelle.ValidationResult();
        if (request.Id <= 0)
            errors.Add(new global::Caravelle.ValidationError("Id must be positive", "POSITIVE"));
...
public class LoadValidateHandler
{
    ...
    public global::Caravelle.ValidationResult Validate(Entity entity)
    {
        var errors = new global::Caravelle.ValidationResult();
        if (entity.Id > 100)
            errors.Add(new global::Caravelle.ValidationError("Id out of range", "OUT_OF_RANGE"));
        return errors;
    }
...
public class ValidateTupleResultHandler
{
    ...
    public (global::Caravelle.ValidationResult validation, Prepared prepared) Validate(Request request)
    {
        var errors = new global::Caravelle.ValidationResult();
...
public class HandleTupleValidationHandler
{
    ...
    public (Response response, global::Caravelle.ValidationResult validation) Handle(Request request)
    {
        var errors = new global::Caravelle.ValidationResult();
        if (request.Id <= 0)
            errors.Add(new global::Caravelle.ValidationError("Id must be positive", "POSITIVE"));
...
public class PostValidationHandler
{
    ...
    public global::Caravelle.ValidationResult PostValidate(Audit audit)
    {
        var errors = new global::Caravelle.ValidationResult();
        if (audit.Value == "INVALID")
            errors.Add(new global::Caravelle.ValidationError("Value is invalid", "POST_INVALID"));
        return errors;
    }
}
