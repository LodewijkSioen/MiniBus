...
public class RegistrationsSourceBuilderTests
{
    ...
    private static HandlerModel MakeModel(
        ...
        new HandlerModel(
            ...
            ResultValueTypes: new EquatableArray<ResultValueType>(new[]
            {
                ...
                new ResultValueType("global::Bus.ValidationResult<global::Bus.ValidationError>", true),
                new ResultValueType("global::Bus.NotFoundResult", true)
            }),
    ...
    [Test]
    public Task AllConflicting_CaravelleExtensionsIsEmpty() =>
        Verify(RegistrationsSourceBuilder.Build(
            new[]
            {
                MakeModel("HandlerOne", "global::TestApp.SharedRequest", "global::TestApp.HandlerOne.Response"),
