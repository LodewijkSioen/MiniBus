...
public class IntegrationTests
{
    ...
    public void MatchParameterNames_UseSemanticNames_ForSingleValidationAndNotFound()
    {
        ...
        Assert.That(dispatcher.Contains("global::System.Func<global::Caravelle.ValidationResult, T> onInvalid", StringComparison.Ordinal), Is.True);
        Assert.That(dispatcher.Contains("global::System.Func<global::Caravelle.NotFoundResult, T> onNotFound", StringComparison.Ordinal), Is.True);
    }
